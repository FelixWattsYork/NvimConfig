...
ls.add_snippets(nil, {
  tex = {
    -- General case for any character followed by ', but NOT "sin'"
    s(
    ...
    -- hat ,i.e \hat{}
    s(
      { trig = "([^%a])ht", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
      fmta("<>\\hat{<>}", {
        f(function(_, snip)
          return snip.captures[1]
        end),
    ...
    -- BAR ,i.e \bar{}
    s(
      { trig = "([^%a])br", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
      fmta("<>\\bar{<>}", {
        f(function(_, snip)
          return snip.captures[1]
        end),
    ...
    -- tilde
    s(
      { trig = "([^%\\])tld", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
      fmta("<>\\tilde{<>}", {
        f(function(_, snip)
          return snip.captures[1]
        end),
    ...
    -- wide tilde
    s(
      { trig = "([^%\\])wtld", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
      fmta("<>\\widetilde{<>}", {
        f(function(_, snip)
          return snip.captures[1]
        end),
    ...
    --  hat
    s(
      { trig = "([^%\\])htt", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
      fmta("<>\\hat{<>}", {
        f(function(_, snip)
          return snip.captures[1]
        end),
